<h1 align='center'>Surfside Software</h1>
...
New around here? Access the application at https://cse110-sp24-group17.github.io/cse110-sp24-group17/. The journal is fully accessible on the web using this link, but can also be downloaded as an application! (instructions to download and to use product).
