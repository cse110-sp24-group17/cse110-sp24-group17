import CalendarComponent from "../../source/modules/journal/calendarComponent.js";
import { isSameDay } from "../../source/modules/journal/dateUtil.js";
...
describe("CalendarComponent", () => {
  ...
  test("should grey out dates that are not in the current month", () => {
    ...
    dayElements.forEach((dayElement) => {
      const date = new Date(
        dayElement.textContent + " " + component.curMonthElement.textContent,
      );
