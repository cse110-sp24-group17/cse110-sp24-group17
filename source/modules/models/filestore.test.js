...
describe('FileStore System', () => {
    ...
    test('FileStore sort_files', () => {
        ...
        // Check sorting in 'dir' (should be: subdir1, subdir2, file1, file2)
        expect(filesInDir.map(file => file.get_name())).toEqual(['subdir1', 'subdir2', 'file1.txt', 'file2.txt']);
    });
});
